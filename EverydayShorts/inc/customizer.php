...
function theme_customize_register($wp_customize) {
    ...
    $wp_customize->add_control('color_scheme', array(
        'label' => __('Color Scheme', 'everydayshorts'),
        'section' => 'colors',
        'type' => 'select',
        'choices' => array(),
        'priority' => 1,
    ...
    for ($i = 1; $i <= 5; $i++) {
        ...
        $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_$i", array(
            'label' => sprintf(__('Color %s', 'everydayshorts'), $i),
            'section' => 'colors',
        )));
    }
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_white_contrast", array(
        'label' => __('Text Dark', 'everydayshorts'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_shading_contrast", array(
        'label' => __('Text Light', 'everydayshorts'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, "color_background", array(
        'label' => __('Background', 'everydayshorts'),
        'section' => 'colors',
    )));
    ...
    $wp_customize->add_control('font_scheme', array(
        'label' => __('Font Scheme', 'everydayshorts'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_heading', array(
        'label' => __('Heading Font', 'everydayshorts'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control('font_text', array(
        'label' => __('Text Font', 'everydayshorts'),
        'section' => 'fonts',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_section('typography', array(
        'capability' => 'edit_theme_options',
        'title' => __('Typography', 'everydayshorts'),
        'priority' => 40,
    ));
    ...
    $wp_customize->add_control('typography_scheme', array(
        'label' => __('Typography Scheme', 'everydayshorts'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'typography_base_size', array(
        'type' => 'number',
        'label' => __('Base Size', 'everydayshorts'),
        'section' => 'typography',
        'input_attrs' => array(
            'min'   => 13,
            'max'   => 24,
    ...
    $wp_customize->add_control('typography_heading_weight', array(
        'label' => __('Heading Weight', 'everydayshorts'),
        'section' => 'typography',
        'type' => 'select',
        'choices' => array(
            '100' => __('100 Thin', 'everydayshorts'),
            '300' => __('300 Light', 'everydayshorts'),
            '400' => __('400 Regular', 'everydayshorts'),
            '500' => __('500 Medium', 'everydayshorts'),
            '700' => __('700 Bold', 'everydayshorts'),
            '900' => __('900 Black', 'everydayshorts'),
        ),
    ));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_width', array(
        'type' => 'number',
        'label' => __('Logo max width (px)', 'everydayshorts'),
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_height', array(
        'type' => 'number',
        'label' => __('Logo max height (px)', 'everydayshorts'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'logo_link', array(
        'type' => 'url',
        'label' => __('Logo link href', 'everydayshorts'),
        'section' => 'title_tagline',
        'priority' => 9,
    )));
    ...
    $wp_customize->add_control(new WP_Customize_Cropped_Image_Control($wp_customize, 'custom_favicon', array(
        'label' => __('Favicon', 'everydayshorts'),
        'section' => 'title_tagline',
        'priority' => 8,
        'height' => '64',
        'width' => '64',
        'button_labels' => array(
            'select' => __('Select favicon', 'everydayshorts'),
            'change' => __('Change favicon', 'everydayshorts'),
            'remove' => __('Remove', 'everydayshorts'),
            'default' => __('Default', 'everydayshorts'),
            'placeholder' => __('No favicon selected', 'everydayshorts'),
            'frame_title' => __('Select favicon', 'everydayshorts'),
            'frame_button' => __('Choose favicon', 'everydayshorts'),
        ),
    )));
    ...
    $wp_customize->add_section('menu_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Theme options', 'everydayshorts'),
        'panel' => 'nav_menus',
    ));
    ...
    $wp_customize->add_control('menu_trim_title', array(
        ...
        'label' => __('Trim long menu items', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('menu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each item to [N] characters', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('submenu_trim_len', array(
        'type' => 'number',
        'section' => 'menu_options',
        'label' => __('Limit each subitem to [N] characters', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('menu_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Apply menu item tag filter', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('menu_allowed_tags', array(
        'type' => 'text',
        'section' => 'menu_options',
        'label' => __('Allowed menu item tags', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('use_default_menu', array(
        'type' => 'checkbox',
        'section' => 'menu_options',
        'label' => __('Use not stylized menu', 'everydayshorts'),
        'description' => __('Used standart wp_nav_menu when option is enabled (need for some third-party plugins).', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_section('excerpt_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Excerpt', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_auto', array(
        ...
        'label' => __('Use auto excerpts', 'everydayshorts'),
        'description' => __('Generate post excerpts automatically (When neither more-tag nor post excerpt is used)', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_words', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt length (words)', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_min_remainder', array(
        'type' => 'number',
        'section' => 'excerpt_options',
        'label' => __('Excerpt balance (words)', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_strip_shortcodes', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Remove shortcodes from excerpt', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_use_tag_filter', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Apply excerpt tag filter', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('excerpt_allowed_tags', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('Allowed excerpt tags', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('show_morelink', array(
        'type' => 'checkbox',
        'section' => 'excerpt_options',
        'label' => __('Show More Link', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('morelink_template', array(
        'type' => 'text',
        'section' => 'excerpt_options',
        'label' => __('More Link Template', 'everydayshorts'),
        'description' => sprintf(__('ShortTags: %s', 'everydayshorts'), '[url], [text]'),
    ));
    ...
    $wp_customize->add_control('seo_og', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include Open Graph meta tags', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('seo_ld', array(
        'type' => 'checkbox',
        'section' => 'seo_options',
        'label' => __('Include schema.org JSON-LD syntax markup', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_section('templates_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Templates', 'everydayshorts'),
        'priority' => 200,
    ));
        ...
        foreach ($templates_parameters as $templateIndex => $template_options) {
                ...
                if (isset($op['options'])) {
                    foreach ($op['options'] as $key => $option) {
                        if (strpos($key, $templateKey . 'Template') === 0) {
                            ...
                            $templatesOptions[$templateKey][$key] = __($option, 'everydayshorts');
                        }
                    }
                }
            }
            if (!in_array($templateKey, $woocommerceTemplateNames) || (in_array($templateKey, $woocommerceTemplateNames) && theme_woocommerce_enabled())) {
                ...
                $wp_customize->add_control( 'theme_template_' . $template . '_' . $templateName . '-template', array(
                    ...
                    'label'       => __( $templateLabel, 'everydayshorts' ),
                    'description' => '',
                ) );
            }
        }
    ...
    $wp_customize->add_section('other_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Other settings', 'everydayshorts'),
        'priority' => 200,
    ));
    ...
    $wp_customize->add_control('include_jquery', array(
        ...
        'label' => __('Use jQuery from theme', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_section('sidebar_options', array(
        'capability' => 'edit_theme_options',
        'title' => __('Sidebars', 'everydayshorts'),
        'priority' => 100,
    ));

    $layouts_choices = array(
        '' => __('Default', 'everydayshorts'),
        'left-sidebar' => __('Left', 'everydayshorts'),
        'right-sidebar' => __('Right', 'everydayshorts'),
        'none' => __('None', 'everydayshorts'),
    );
    ...
    $wp_customize->add_control('sidebars_layout_blog', array(
        ...
        'label' => __('Blog Template', 'everydayshorts'),
        'description' => __('Templates for displaying blogs, archives, search results', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_post', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Post Template', 'everydayshorts'),
        'description' => __('Templates for displaying single posts', 'everydayshorts'),
    ));
    ...
    $wp_customize->add_control('sidebars_layout_default', array(
        ...
        'choices' => $layouts_choices,
        'section' => 'sidebar_options',
        'label' => __('Default Template', 'everydayshorts'),
        'description' => __('Templates for displaying single pages and everything else', 'everydayshorts'),
    ));
}
add_action('customize_register', 'theme_customize_register', 11);

function theme_print_sidebars_blog_caption() {
    printf('<h3>%s</h3>', __('Display sidebars on:', 'everydayshorts'));
}
