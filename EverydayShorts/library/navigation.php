...
class Theme_NavMenu {
    ...
    public static function _linkAttrsFilter($atts, $item, $args, $depth) {
        if ($args->theme_location === self::$_themeLocation) {
            if ($depth === 0) {
                ...
                $class = isset(self::$_sub_submenuLinkClass) && self::$_sub_submenuLinkClass ? self::$_sub_submenuLinkClass : self::$_submenuLinkClass;
                $style = isset(self::$_sub_submenuLinkStyle) && self::$_sub_submenuLinkStyle ? self::$_sub_submenuLinkStyle : self::$_submenuLinkStyle;
            }
            if ($class) {
    ...
    public static function getMenuHtml($args) {
        ...
        self::$_sub_submenuLinkClass = isset($args['menu']['mega_menu'][0]) && isset($args['menu']['mega_menu'][0]['sub_submenu_link_class']) ? $args['menu']['mega_menu'][0]['sub_submenu_link_class'] : '';
        self::$_sub_submenuLinkStyle = isset($args['menu']['mega_menu'][0]) && isset($args['menu']['mega_menu'][0]['sub_submenu_link_style']) ? $args['menu']['mega_menu'][0]['sub_submenu_link_style'] : '';
