...
function theme_ld_meta_tags() {
    ...
    $social_links = apply_filters('theme_social_links', array("https://www.youtube.com/channel/UCrFtU8Z4_PTi3EHziBOuXOQ/channels"));
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#ab4ec7');
